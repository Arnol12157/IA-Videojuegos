...
public class UnitySphinx : MonoBehaviour {
	...
	public static void Init() {
		...
		hmm = Application.dataPath + "/5 Miscellaneous/Voice Recognizer/Resources/UnitySphinx/model/en-us/en-us";
		lm = Application.dataPath + "/5 Miscellaneous/Voice Recognizer/Resources/UnitySphinx/model/en-us/en-us.lm.bin";
		dict = Application.dataPath + "/5 Miscellaneous/Voice Recognizer/Resources/UnitySphinx/model/en-us/cmudict-en-us.dict";

		jsgf = Application.dataPath + "/5 Miscellaneous/Voice Recognizer/Resources/UnitySphinx/model/en-us/ordenes.gram";
		kws = Application.dataPath + "/5 Miscellaneous/Voice Recognizer/Resources/UnitySphinx/model/en-us/keyphrase1.list";
